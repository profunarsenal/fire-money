<template>
  <div class="calculator" :class="{ 'calculator-form': pathForm }">
    <div class="range-block" :class="{ 'range-block-form': pathForm }">
      <div class="range-sum-block" :class="{ 'range-sum-form': pathForm }">
      ...
      <div class="range-term-block" :class="{ 'range-term-form': pathForm }">
    ...
    <div class="calculator-block" :class="{ 'calculator-form': pathForm }">
      <div class="calculator-row" :class="{ 'row-form': pathForm }">
        <div class="calculator-item" :class="{ 'item-form': pathForm }">
...
export default {
  ...
  data() {
    return {
      ...
      pathForm: this.$router.options.history.location === `/form`,
    };
  },
