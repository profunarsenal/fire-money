    ...
    <div class="container">
      <div class="receiving-page-wrapper">
        <div class="receiving-load">
          <title-page v-if="!verification" :title="userTitle" />
          <title-page v-if="verification" title="Ваша заявка принята!" />
          <h6 v-if="!verification" class="receiving-subtitle">
            Мы проверяем введенные вами данные
          </h6>
          <h6 v-if="verification" class="receiving-subtitle">
            Наш специалист свяжется с вами в ближайшее время, для подтверждения
            заявки. Спасибо!
          </h6>
          ...
          <div v-if="!verification" class="receiving-image">
            ...
            <pre-loader class="receiving-loader" />
          </div>
        </div>
      </div>
    </div>
